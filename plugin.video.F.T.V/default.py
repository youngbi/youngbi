...
#    if dialog.yesno(" Streams addon is installed", ' Streams uses stolen code from many developers', 'They contribute NOTHING to the community', 'Quit this addon or make a choice', 'Quit this addon','Choose an addon to uninstall'):
