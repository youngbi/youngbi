...
def get_Setting():
	...
	try:
		if CHECK=="false":
			...
			yes_pressed=DIALOG.yesno(ADDON_NAME,"Bạn có muốn thiết lập cấu hình Addon [COLOR red]VietmediaF[/COLOR] cho lần chạy đầu tiên không?", "[COLOR dimgrey]VMF Code, Fshare Account, Fptplay, Thư mục download, Mã Khóa...[/COLOR]", nolabel='No, Cancel', yeslabel='Yes, Continue')
			if yes_pressed:
