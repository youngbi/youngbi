...
mysettings=xbmcaddon.Addon(id='plugin.video.phim7')
...
def categories(url):
  ...
  if 'phim3s' in url:
    ...
    addDir('[COLOR cyan][B][COLOR lime]>[COLOR cyan]>[COLOR orange]>[COLOR magenta]>   [/B][COLOR cyan]Tìm Phim[/COLOR]',megaboxvn,1,logos+'megabox.png')
