...
ADDON = xbmcaddon.Addon(id='plugin.video.hieuhien.vn.footballreplays')
...
def CATEGORIES():
    addDir('[COLOR lime]Xem lai toan bo tran dau[/COLOR]','url',3,'','1')
    addDir('[COLOR red]*Mo website "[COLOR white]openload.co/pair[/COLOR]" tren may, bam nut "[COLOR white]Pair[/COLOR]" [/COLOR]','',4,'','1')
    addDir('[COLOR red]de cho phep [COLOR white]dia chi IP[/COLOR] cua ban xem link [COLOR white]OPENLOAD.CO[/COLOR]*[/COLOR]','',4,'','1')
    addDir('[COLOR yellow]Xem lai tom tat tran dau[/COLOR]','url',5 ,'','1')
	#addDir('[COLOR red]*Luu y: truy cap "openload.co/pair" bam nut "Pair" de xem Openload[/COLOR]','url',4,'','1')
    setView('movies', 'main') 
