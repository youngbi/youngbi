...
PLUGIN='plugin.video.hieuhien.vn.footballreplays'
...
def CATEGORIES():
    addDir('Xem lai toan bo tran dau','url',3,'','1')
    addDir('Tim kiem theo ten doi bong','url',4,'','1')
    addDir('Tom tat tran dau','url',5 ,'','1')
    setView('movies', 'main') 
