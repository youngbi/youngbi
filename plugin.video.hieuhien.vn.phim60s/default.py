...
oo000 = Plugin ( )
ii = "plugin://plugin.video.hieuhien.vn.phim60s"
oOOo = 32
...
def iiiIi1i1I ( url ) :
 ...
 oOO00oOO . create ( 'Hieuhien.vn' , 'Loading video. Please wait...' )
...
O0oOO0 = xbmc . translatePath ( xbmcaddon . Addon ( 'plugin.video.hieuhien.vn.phim60s' ) . getAddonInfo ( 'profile' ) )
