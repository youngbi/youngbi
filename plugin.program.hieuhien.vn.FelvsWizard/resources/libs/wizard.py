			...
			for root, dirs, files in os.walk(PACKAGES):
				...
				if file_count > 0:
					...
					if yes:
						...
						#LogNotify(ADDONTITLE,'Xoa Pagekage: [COLOR green]Hoan thanh[/COLOR]!!!')
				else: tam=1 #LogNotify(ADDONTITLE,'Xoa Package: [COLOR red]da xoa het!!![/COLOR]')
		except: tam=2 #LogNotify(ADDONTITLE,'Xoa Package: [COLOR red]Loi[/COLOR]!!!')
	else: tam=3 #LogNotify(ADDONTITLE,'Xoa Package: [COLOR red]Da xoa het!!![/COLOR]')
...
def clearCache():
	...
	#LogNotify(ADDONTITLE,'Xoa Cache: da xoa %s tap tin rac' % delfiles)
