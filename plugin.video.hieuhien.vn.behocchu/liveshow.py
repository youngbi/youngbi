...
addonID = 'plugin.video.hieuhien.vn.behocchu'
...
temp = 'aHR0cDovL3d3dy5oaWV1aGllbi52bi9YQk1DL0JFSE9DQ0hVL01lbnUueG1s'	
...
if mode == 'tvchannel':TVChannel(url)	
    ...
    dialogWait.create('[COLOR red]Tuấn Tàu[/COLOR] - [COLOR lime]Đang tải, vui lòng chờ...[/COLOR]')
    resolveUrl(url)
    dialogWait.close()
    del dialogWait	
elif mode=='play':
