# -*- coding: utf-8 -*-
ZeusStreamVersion = "V1.0.3"
ZeusStreamDate = "07/06/2015 13:00hrs GMT"
...
ZeusLocoNum = 'http://zeusrepo.com/alpha/loconum.php?num='
...
def LookLocoNum():
    ...
    if LocoNum == '':
       LocoNum = ZeusGetContent(ZeusLocoNum+'blank')
    else:
       LocoNum = ZeusGetContent(ZeusLocoNum+LocoNum)
