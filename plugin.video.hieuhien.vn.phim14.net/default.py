...
oo000 = Plugin ( )
ii = "plugin://plugin.video.hieuhien.vn.phim14.net"
oOOo = 32
...
def iiI1 ( url ) :
 ...
 i11Iiii . create ( 'Hieuhien.vn' , 'Loading video. Please wait...' )
...
I1i1III = xbmc . translatePath ( xbmcaddon . Addon ( 'plugin.video.hieuhien.vn.phim14.net' ) . getAddonInfo ( 'profile' ) )
