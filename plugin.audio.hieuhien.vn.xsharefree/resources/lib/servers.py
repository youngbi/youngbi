...
class servers_list:
	def __init__(self):
		self.servers=[('hdviet.com', '22'),('bilutv.com', '36'),('phimmoi.net', '24'), ('hdonline.vn', '30'), ('megabox.vn', '17'),('phimbathu.com', '43'),  ('imovies.vn', '48'), ('phim.media', '40'),('phim3s.net', '32'), ('phim14.net', '39'),   ('fptplay.net', '07'), ('hayhaytv.vn', '23'),   ('kenh88.com', '26'), ('phimdata.com', '27'), ('phim47.com', '28'), ('hdsieunhanh.com', '44'), ('vietsubhd.com', '54'), ('mphim.net', '55'), ('anime47.com', '37'),('tvhay.org', '41'),('phimnhanh.com', '35'), ('kphim.tv', '33'),  ('phimsot.com', '29')]
